...
describe("ConfigStore", () => {
  ...
  it("keeps every section in one file", () => {
    ...
    config.saveUi({ project: "C--Users-Terry", cursor: 4, theme: "dark", monitor: true, window: null, navWidth: 0, asideWidth: 0 });
  ...
  it("normalises a hand-edited file instead of crashing", () => {
    ...
    expect(config.ui()).toEqual({ project: null, cursor: 0, theme: "system", monitor: true, window: null, navWidth: 0, asideWidth: 0 });
  });
